...
if (place_meeting(x, y, obj_cancer)) {
    if (attack_cooldown <= 0) {
        ...
        if (player != noone) {
            player.hp -= 2; // Наносим 1 урон игроку
